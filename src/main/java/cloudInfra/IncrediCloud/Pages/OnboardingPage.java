...
public class OnboardingPage {
    ...
    public OnboardingPage(String region, String firstName, String lastName, String email, String company, int timeout, int coresLimit, int poolSize, int coordPort, int vmPort) {
        this.region = region;
