...
//        Assert.assertEquals(exitCode, 0, "Test " + testName + " failed with Exit code " + exitCode);
    ...
    public void SimdCHroot() {
        ...
        int exitCode = linuxService.linuxRunSSHCommand("mount|grep chroot", ipList.get(simClassType.ordinal()));
       ...
       exitCode = linuxService.linuxRunSSHCommand("sudo chroot /chroot/xenial_u16 /bin/bash -c \"" + StaticDataProvider.LinuxSimulation.CHROOT_KERNEL4_DIR + "; "
