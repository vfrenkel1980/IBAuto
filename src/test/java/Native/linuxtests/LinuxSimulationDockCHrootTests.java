...
public class LinuxSimulationDockCHrootTests extends LinuxSimTestBase {
    ...
    public void SimdDockerKenrel4Run() {
        ...
        int exitCode = linuxService.linuxRunSSHCommand("/opt/incredibuild/bin/ib_docker run -w /disk2/projects/linux-4.3.3 " +
                "-v /disk2/projects:/disk2/projects --name IB-Test01 5624cdd7a83e ib_console --ib-crash -d1 -c dockKernel make -j32", ipList.get(2));

        if (exitCode != 0) {
            linuxService.linuxRunSSHCommand("docker stop IB-Test01", ipList.get(2));
            linuxService.linuxRunSSHCommand("docker rm IB-Test01", ipList.get(2));
    ...
    public void SimdDckerKenrel4Exec() {
        ...
        int exitCode = linuxService.linuxRunSSHCommand("/opt/incredibuild/bin/ib_docker run -td -w /disk2/projects/linux-4.3.3 -v /disk2/projects:/disk2/projects --name IB-Test02 5624cdd7a83e", ipList.get(2));
        ...
        Assert.assertEquals(exitCode, 0, "Test " + testName + "a failed with Exit code " + exitCode);

        exitCode = linuxService.linuxRunSSHCommand("/opt/incredibuild/bin/ib_docker run -td -w /disk2/projects/linux-4.3.3 -v /disk2/projects:/disk2/projects --name IB-Test02 5624cdd7a83e", ipList.get(2));
        Assert.assertEquals(exitCode, 0, "Test " + testName + "a failed with Exit code " + exitCode);
    ...
    @Test(testName = "Sim docker kenrel4 run privileged")
    public void SimdDockerKenrel4RunPrivileged() {

        linuxService.linuxRunSSHCommand("docker rm IB-Test03", ipList.get(2));

        linuxService.linuxRunSSHCommand("/opt/incredibuild/bin/ib_docker run -w /disk2/projects/linux-4.3.3 -v /disk2/projects:/disk2/projects --name IB-Test03 5624cdd7a83e make clean", ipList.get(2));

        linuxService.linuxRunSSHCommand("docker rm IB-Test03", ipList.get(2));

        int exitCode = linuxService.linuxRunSSHCommand("/opt/incredibuild/bin/ib_docker run -w /disk2/projects/linux-4.3.3 " +
                "-v /disk2/projects:/disk2/projects --privileged --name IB-Test03 5624cdd7a83e ib_console --ib-crash -d1 -c dockKernelPrivileged make -j32", ipList.get(2));

        if (exitCode != 0) {
            linuxService.linuxRunSSHCommand("docker stop IB-Test03", ipList.get(2));
            linuxService.linuxRunSSHCommand("docker rm IB-Test03", ipList.get(2));
            Assert.assertEquals(exitCode, 0, "Test " + testName + " failed with Exit code " + exitCode);
        }
        ...
        linuxService.linuxRunSSHCommand("/opt/incredibuild/bin/ib_docker run -w /disk2/projects/linux-4.3.3 " +
                "-v /disk2/projects:/disk2/projects --name IB-Test03 5624cdd7a83e make clean", ipList.get(2));
    ...
    public void SimdDckerKenrel4ExecPrivileged() {
        ...
        int exitCode = linuxService.linuxRunSSHCommand("/opt/incredibuild/bin/ib_docker run -td -w /disk2/projects/linux-4.3.3 -v /disk2/projects:/disk2/projects --privileged --name IB-Test04 5624cdd7a83", ipList.get(2));

        linuxService.linuxRunSSHCommand("docker exec IB-Test04 make clean", ipList.get(2));
        linuxService.linuxRunSSHCommand("docker stop IB-Test04", ipList.get(2));
        linuxService.linuxRunSSHCommand("docker rm IB-Test04", ipList.get(2));
        Assert.assertEquals(exitCode, 0, "Test " + testName + "a failed with Exit code " + exitCode);

        exitCode = linuxService.linuxRunSSHCommand("/opt/incredibuild/bin/ib_docker run -td -w /disk2/projects/linux-4.3.3 -v /disk2/projects:/disk2/projects --privileged --name IB-Test04 5624cdd7a83", ipList.get(2));
        exitCode = linuxService.linuxRunSSHCommand("docker exec IB-Test04 ib_console --ib-crash -d1 -c exec_dockKernelPrivileged make -j32", ipList.get(2));
        linuxService.linuxRunSSHCommand("docker exec IB-Test04 make clean", ipList.get(2));
        linuxService.linuxRunSSHCommand("docker stop IB-Test04", ipList.get(2));
        linuxService.linuxRunSSHCommand("docker rm IB-Test04", ipList.get(2));
        Assert.assertEquals(exitCode, 0, "Test " + testName + " failed with Exit code " + exitCode);
