...
public class PhoenixSingleUseVMTests extends SingleUseVMTestBase {
    ...
    public void setUp() {
        ibService.agentServiceStart();
        winService.runCommandWaitForFinish(Processes.PSEXEC + " \\\\" + WindowsMachines.BABYLON + " -u Administrator -p 4illumination -i 0 " + IbLocations.XGCOORDCONSOLE +" /Agents="+WindowsMachines.PHOENIX+" /Subscribe");
